...
#ifdef CONFIG_USB_ANDROID_SH_IF_SMEM
#include "sharp/sh_smem.h"
#endif /* CONFIG_USB_ANDROID_SH_IF_SMEM */
		...
		struct usb_composite_dev *cdev)
{
	...
	dev->sdev.print_name = print_switch_name_rndis;
	dev->sdev.print_state = print_switch_state_rndis;
	if (switch_dev_register(&dev->sdev) < 0) {
