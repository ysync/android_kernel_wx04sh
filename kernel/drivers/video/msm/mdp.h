...
#define MDP_DMAP_CSC_MV1n(n)		(msm_mdp_base + 0x93400 + 4 * (n))
#define MDP_DMAP_CSC_PRE_BV1n(n)	(msm_mdp_base + 0x93500 + 4 * (n))
#define MDP_DMAP_CSC_POST_BV1n(n)	(msm_mdp_base + 0x93580 + 4 * (n))
#define MDP_DMAP_CSC_PRE_LV1n(n)	(msm_mdp_base + 0x93600 + 4 * (n))
#define MDP_DMAP_CSC_POST_LV1n(n)	(msm_mdp_base + 0x93680 + 4 * (n))
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00014 */ /* CUST_ID_00037 */ /* CUST_ID_00038 */ /* CUST_ID_00058 */ /* CUST_ID_00083 */ /* CUST_ID_00096 */ /* CUST_ID_00117 */
