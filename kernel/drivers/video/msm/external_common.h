...
/* SHMHL Add Start --> */
#ifdef SHMHL_DEBUG_LOG_SYS_FS_ENTRY
#define DEV_DBG(args...)	if(shmhl_get_debug_flg(SHMHL_DEBUG_LOG_HDMI)){printk(KERN_ERR "[HDMI] " args);}
#define DEV_INFO(args...)	if(shmhl_get_debug_flg(SHMHL_DEBUG_LOG_HDMI)){printk(KERN_ERR "[HDMI] " args);}
#define DEV_WARN(args...)	if(shmhl_get_debug_flg(SHMHL_DEBUG_LOG_HDMI)){printk(KERN_ERR "[HDMI] " args);}
#define DEV_ERR(args...)	if(shmhl_get_debug_flg(SHMHL_DEBUG_LOG_HDMI)){printk(KERN_ERR "[HDMI] " args);}
#else /* SHMHL Add End <-- */
