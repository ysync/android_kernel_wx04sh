...
#include "msm_fb.h"
#include "mdp4.h"
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00133 */
#include "hdmi_msm.h"
#endif
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00133 */ /* CUST_ID_00144 */
static int hdmi_open_cancel;
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00133 */
	if (!external_common_state || !external_common_state->hpd_state) {
		hdmi_open_cancel = 1;
		return ret;
	}
	else {
