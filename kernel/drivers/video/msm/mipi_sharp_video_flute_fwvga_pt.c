/* drivers/video/msm/mipi_sharp_video_flute_fwvga_pt.c  (Display Driver)
 *
...
static int __init mipi_video_sharp_flute_fwvga_pt_init(void)
{
	int ret;

#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("mipi_video_sharp_flute_fwvga"))
		return 0;
#endif
...
module_init(mipi_video_sharp_flute_fwvga_pt_init);
