...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00024 */ /* CUST_ID_00116 */
...
void msm_fb_set_backlight(struct msm_fb_data_type *mfd, __u32 bkl_lvl)
{
	...
	if ((pdata) && (pdata->set_backlight)) {
		...
		mfd->bl_level = temp;
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00061 */ /* CUST_ID_00075 */ /* CUST_ID_00094 */
		bl_level_old = temp;
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00048 */ /* CUST_ID_00134 */ /* CUST_ID_00159 */
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00021 */ /* CUST_ID_00075 */ /* CUST_ID_00094 */
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00048 */ /* CUST_ID_00134 */ /* CUST_ID_00144 */ /* CUST_ID_00159 */
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00065 */ /* CUST_ID_00086 */ /* CUST_ID_00093 */
	if (mfd->index != 0) {
		mfd->display_iova = 0;
		mfd->rotator_iova = 0;
	} else {
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00075 */ /* CUST_ID_00137 */
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00021 */ /* CUST_ID_00038 */ /* CUST_ID_00051 */ /* CUST_ID_00058 */ /* CUST_ID_00075 */ /* CUST_ID_00089 */ /* CUST_ID_00090 */
static int msmfb_notify_panelsave(struct fb_info *info, unsigned long *argp)
{
	...
	if (panelsave_status.direction == MSMFB_PANELSAVE_ENABLE) {
		if (mfd->panel_power_on || !mfd->cont_splash_done) {
			INIT_COMPLETION(mfd->msmfb_panelsave_notify);
