...
struct msm_fb_data_type {
	...
	int (*lut_get) (struct fb_info *info,
			      struct msmfb_dma_abl_lut_read_data *p);
#endif	/* CONFIG_SHLCDC_BOARD */
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00006 */ /* CUST_ID_00021 */ /* CUST_ID_00085 */
	struct completion msmfb_panelsave_notify;
#endif	/* CONFIG_SHLCDC_BOARD */
};
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00024 */ /* CUST_ID_00071 */ /* CUST_ID_00116 */
