...
#define SHDISP_BDIC_REQ_TRI_LED_SET_ONTIME          11
#define SHDISP_BDIC_REQ_TRI_LED_SET_INTERVAL        12
#define SHDISP_BDIC_REQ_PHOTO_SENSOR_CONFIG         13
#define SHDISP_BDIC_REQ_BKL_PWM_DISABLE             14
#define SHDISP_BDIC_REQ_BKL_PWM_ENABLE              15
#define SHDISP_BDIC_REQ_BKL_DTV_OFF                 16
#define SHDISP_BDIC_REQ_BKL_DTV_ON                  17
#define SHDISP_BDIC_REQ_BKL_EMG_OFF                 18
#define SHDISP_BDIC_REQ_BKL_EMG_ON                  19
#define SHDISP_BDIC_REQ_BKL_ECO_OFF                 20
#define SHDISP_BDIC_REQ_BKL_ECO_ON                  21
#define SHDISP_BDIC_REQ_BKL_CHG_OFF                 22
#define SHDISP_BDIC_REQ_BKL_CHG_ON                  23

#define SHDISP_BDIC_REQ_PRE_START                   24
#define SHDISP_BDIC_REQ_POST_START                  25
...
struct shdisp_bdic_state_str{
    int bdic_power_status;
    int bdic_power_status_tbl[NUM_SHDISP_BDIC_DEV_TYPE];
    int bdic_power_resume_tbl[NUM_SHDISP_BDIC_DEV_TYPE];
    int bdic_is_exist;
    int bdic_main_bkl_opt_mode_output;
    int bdic_main_bkl_opt_mode_ado;
    unsigned long photo_sensor_user;
    unsigned long prox_sensor_user;
    unsigned char shdisp_lux_change_level1;
    unsigned char shdisp_lux_change_level2;
    unsigned char als_adj0_low;
    unsigned char als_adj0_high;
    unsigned char als_adj1_low;
    unsigned char als_adj1_high;
    unsigned char als_shift;
    unsigned char clear_offset;
    unsigned char ir_offset;
    int bkl_adjust_val;
    struct shdisp_prox_params shdisp_bdic_prox_params;
};
