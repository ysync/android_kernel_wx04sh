...
extern struct st_shlcdc_eventlog *shlcdc_eventlog;
extern struct st_shlcdc_eventlog *shlcdc_busylog;
extern struct st_shlcdc_eventlog *shlcdc_errlog;
extern unsigned long shlcdc_eventlog_cnt;
extern unsigned long shlcdc_busylog_cnt;
extern unsigned long shlcdc_errlog_cnt;
extern unsigned long shlcdc_eventlog_size;
extern unsigned long shlcdc_busylog_size;
extern unsigned long shlcdc_errlog_size;
...
static int __init shrlog_set_fixed_info( void )
{
    ...
    fixed_info.shlcdc_eventlog         = (unsigned long)shlcdc_eventlog;
    fixed_info.shlcdc_busylog          = (unsigned long)shlcdc_busylog;
    fixed_info.shlcdc_errlog           = (unsigned long)shlcdc_errlog;
    fixed_info.shlcdc_eventlog_cnt     = (unsigned long)(&shlcdc_eventlog_cnt);
    fixed_info.shlcdc_busylog_cnt      = (unsigned long)(&shlcdc_busylog_cnt);
    fixed_info.shlcdc_errlog_cnt       = (unsigned long)(&shlcdc_errlog_cnt);
    fixed_info.shlcdc_eventlog_size    = (unsigned long)(&shlcdc_eventlog_size);
    fixed_info.shlcdc_busylog_size     = (unsigned long)(&shlcdc_busylog_size);
    fixed_info.shlcdc_errlog_size      = (unsigned long)(&shlcdc_errlog_size);
