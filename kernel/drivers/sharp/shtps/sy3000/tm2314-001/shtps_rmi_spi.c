/* drivers/sharp/shtps/sy3000/tm2314-001/shtps_rmi_spi.c
 *
...
#define SHTPS_POS_SCALE_Y(ts)	(((CONFIG_SHTPS_SY3000_PANEL_SIZE_Y) * 10000) / ts->map.fn11.ctrl.maxYPosition)
		...
		static int SHTPS_CHARGER_ARMOR_STRENGTH =		0x18;
		...
		#define SHTPS_CHARGER_ARMOR_STRENGTH			0x18
	#endif /* #if defined( SHTPS_DEBUG_VARIABLE_DEFINES ) */
...
enum{
	...
	SHTPS_IRQ_LED 		= 0x10,
	SHTPS_IRQ_BUTTON 	= 0x20,
	SHTPS_IRQ_SENSOR 	= 0x40,
