...
enum {
	PERF_LOCK_384MHz,	/* PERF_LEVEL0 */
	PERF_LOCK_486MHz,	/* PERF_LEVEL1 */
	PERF_LOCK_594MHz,	/* PERF_LEVEL2 */
	PERF_LOCK_702MHz,	/* PERF_LEVEL3 */
	PERF_LOCK_810MHz,	/* PERF_LEVEL4 */
	PERF_LOCK_918MHz,	/* PERF_LEVEL5 */
	PERF_LOCK_1026MHz,	/* PERF_LEVEL6 */
	PERF_LOCK_1134MHz,	/* PERF_LEVEL7 */
	PERF_LOCK_1242MHz,	/* PERF_LEVEL8 */
	PERF_LOCK_1350MHz,	/* PERF_LEVEL9 */
	PERF_LOCK_1458MHz,	/* PERF_LEVEL10 */
	PERF_LOCK_1512MHz,	/* PERF_LEVEL11 */
	PERF_LOCK_HIGHEST = PERF_LOCK_1512MHz,
