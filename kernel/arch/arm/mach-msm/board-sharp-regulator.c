...
#endif /* defined(CONFIG_WEBCAM_OV7692) || defined(CONFIG_WEBCAM_S5K8AAYX) */
};
VREG_CONSUMERS(L9) = {
...
VREG_CONSUMERS(L11) = {
	...
	REGULATOR_SUPPLY("cam_vana",		"4-007a"),
...
VREG_CONSUMERS(L12) = {
	...
	REGULATOR_SUPPLY("cam_vdig",		"4-0078"),
...
VREG_CONSUMERS(L17) = {
	...
	REGULATOR_SUPPLY("shtps_nas_vdda",	"spi_qsd.9"),
...
/*	REGULATOR_SUPPLY("iris_vdddig",		"wcnss_wlan.0"), */
	...
	REGULATOR_SUPPLY("cam_vdd",		"4-0034"),
#endif /* defined(CONFIG_IMX091) */
#if defined(CONFIG_S5K4EC)
	REGULATOR_SUPPLY("cam_vdd",		"4-007a"),
#endif /* defined(CONFIG_S5K4EC) */
};
VREG_CONSUMERS(LVS3) = {
...
msm_pm8921_regulator_pdata[] __devinitdata = {
	...
	PM8XXX_NLDO1200(L26, "8921_l26", 0, 1, 375000, 1100000, 200, "8921_s7",
		0, 1),
	PM8XXX_NLDO1200(L27, "8921_l27", 0, 1, 375000, 1100000, 200, "8921_s7",
		0, 2),
	PM8XXX_NLDO1200(L28, "8921_l28", 0, 1, 375000, 1100000, 200, "8921_s7",
		0, 3),
...
msm_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_SMPS(S1, 1, 1, 0, 1225000, 1225000, NULL, 100000, 3p20, NONE, NONE),
	RPM_SMPS(S2, 0, 1, 0, 1300000, 1300000, NULL,      0, 1p60, NONE, NONE),
	RPM_SMPS(S3, 1, 1, 1,  500000, 1150000, NULL, 100000, 4p80, NONE, NONE),
	RPM_SMPS(S4, 1, 1, 0, 1800000, 1800000, NULL, 100000, 1p60, AUTO, AUTO),
	RPM_SMPS(S7, 0, 1, 0, 1150000, 1150000, NULL, 100000, 3p20, NONE, NONE),
	RPM_SMPS(S8, 1, 1, 1, 2050000, 2050000, NULL, 100000, 1p60, NONE, NONE),
#endif /* CONFIG_BATTERY_SH */
	...
	RPM_LDO(L9,	 1, 1, 0, 2950000, 2950000, NULL,      0, 0),
	RPM_LDO(L10,	 0, 1, 0, 2900000, 3000000, NULL,      0, 0),
	RPM_LDO(L11,	 0, 1, 0, 2800000, 2850000, NULL,      0, 0),
#if defined(CONFIG_WEBCAM_S5K8AAYX) || defined(CONFIG_IMX111) || defined(CONFIG_MACH_TOR) /* PENDING_LA17 */
	RPM_LDO(L12,	 0, 1, 0, 1225000, 1225000, "8921_s4", 0, 0),
#else
	RPM_LDO(L12,	 0, 1, 0, 1250000, 1250000, "8921_s4", 0, 0),
#endif /* defined(CONFIG_WEBCAM_S5K8AAYX) || defined(CONFIG_IMX111)  || defined(CONFIG_MACH_TOR) */
	RPM_LDO(L14,	 0, 1, 0, 1800000, 1800000, NULL,      0, 0),
	RPM_LDO(L15,	 0, 1, 0, 1700000, 3300000, NULL,      0, 0),
	...
	RPM_LDO(L23,	 1, 1, 1, 1800000, 1800000, "8921_s8", 10000, 10000),
	RPM_LDO(L24,	 1, 1, 1,  750000, 1225000, "8921_s1", 10000, 10000),
	RPM_LDO(L25,	 1, 1, 0, 1250000, 1250000, "8921_s1", 10000, 10000),
#endif /* CONFIG_BATTERY_SH */
...
void __init msm8960_pm8921_regulator_init(void)
{
	int disflg = 0;
	int idx;
#if defined(CONFIG_PM_REG_L8_ON) || \
	defined(CONFIG_PM_REG_VS300_PD_DIS_TYPE1)
	...
	if ((rev == 0x00000004/*SH_HW_REV_ES0*/) ||
...
#if defined(CONFIG_PM_REG_VS300_PD_DIS_ALWAYS)
	disflg = 1;
#elif defined(CONFIG_PM_REG_VS300_PD_DIS_TYPE1)
	if ((rev == 0x00000004/*SH_HW_REV_ES0*/) ||
		(rev == 0x00000005/*SH_HW_REV_ES1*/))
	{
		/* none */
	...
	if (disflg)
	{
		for (idx = 0; idx < msm_pm8921_regulator_pdata_len; idx++)
		{
			if ((msm_pm8921_regulator_pdata[idx].id == 5) ||
				(msm_pm8921_regulator_pdata[idx].id == 6))
			{
				msm_pm8921_regulator_pdata[idx].pull_down_enable = 0;
			}
		}
	}
}
