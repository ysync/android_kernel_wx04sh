...
#ifdef CONFIG_SND_SOC_YMU828B
static struct i2c_board_info snd_soc_ymu828b_i2c_info[] __initdata = {
	{
...
/* Bone Conduction Receiver control */
...
#ifdef CONFIG_SND_SOC_YMU828B
    {
        I2C_SURF | I2C_FFA | I2C_FLUID | I2C_RUMI,
        MSM_8960_GSBI2_QUP_I2C_BUS_ID,
        snd_soc_ymu828b_i2c_info,
        ARRAY_SIZE(snd_soc_ymu828b_i2c_info),
    },
#endif /* CONFIG_SND_SOC_YMU828B */
#endif /* CONFIG_SH_AUDIO_DRIVER_PHS */
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-180*/
...
static void __init msm8960_cdp_init(void)
{
	...
	if (machine_is_msm8960_mtp() || machine_is_msm8960_fluid() ||
		machine_is_msm8960_cdp() || machine_is_tori() || machine_is_manabe() || machine_is_arisa() || machine_is_deckard_as70() || machine_is_deckard_gp4()) {
	...
	if (machine_is_msm8960_cdp() || machine_is_tori() || machine_is_manabe() || machine_is_arisa() || machine_is_deckard_as70() || machine_is_deckard_gp4())
