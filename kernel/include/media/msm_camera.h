...
#define CFG_SH_SET_AE_LOCK 119
#define CFG_SH_SET_AWB_LOCK 120
#define CFG_SH_SET_GAMMA 121
#define CFG_SH_GET_CAM_INFO 122
#define CFG_SH_GET_STAT_INFO 123
...
struct sensor_cfg_data {
	...
	union {
		...
		struct sh_camera_info_t sh_camera_info;
		struct stat_info_t stat_info;
		int gamma;
	} cfg;
};
...
struct msm_calib_dpc {
	...
	struct pixel_t video60_coord[128];
	struct pixel_t video120_coord[128];
};
