...
typedef enum {
    ...
    SHBATTLOG_EVENT_CABLE_DET_ERR_0,
    SHBATTLOG_EVENT_CABLE_DET_ERR_1,
    SHBATTLOG_EVENT_CABLE_DET_ERR_2,
    SHBATTLOG_EVENT_CABLE_DET_ERR_3,
    SHBATTLOG_EVENT_CABLE_DET_ERR_4,
    SHBATTLOG_EVENT_CABLE_DET_ERR_5,
