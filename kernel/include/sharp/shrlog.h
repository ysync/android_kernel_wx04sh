...
#define SHRLOG_FIXED_APPS_ADDRESS   (0xFA300000 + 0x001FFFF0)
...
typedef struct
{
    ...
    unsigned long shlcdc_eventlog;
    unsigned long shlcdc_busylog;
    unsigned long shlcdc_errlog;
    unsigned long shlcdc_eventlog_cnt;
    unsigned long shlcdc_busylog_cnt;
    unsigned long shlcdc_errlog_cnt;
    unsigned long shlcdc_eventlog_size;
    unsigned long shlcdc_busylog_size;
    unsigned long shlcdc_errlog_size;
