...
void pm8xxx_cc_set_vsense_avg_calibration_data(int imin, int imax, int vmin, int vmax);
...
#ifdef CONFIG_BATTERY_SH
static inline s64 pm8xxx_cc_scale_uv_to_ma(s64 uv)
{
	return -ENXIO;
}
static inline void pm8xxx_cc_set_vsense_avg_calibration_data(int imin, int imax, int vmin, int vmax)
{
}
static inline void pm8xxx_cc_refresh_vsense_avg_calibration_data(void)
{
}
#endif /* CONFIG_BATTERY_SH */
#endif
