...
#define TSIF_NUM_OF_EACH_TSBUFFER	21	/* 192*21 < 4096 < 192*22 */
#define TSIF_MM_TSBUFFER_WIDTH		49	/* 21*48 < 1024 < 21*49 */ 
#define TS_PKT_IN_2ND_BUF   (TSIF_NUM_OF_EACH_TSBUFFER * TSIF_MM_TSBUFFER_WIDTH)

typedef struct {
	unsigned char  *data_buffer_ptr[TSIF_MM_TSBUFFER_WIDTH];		
...
extern tsif_2nd_buffer_t *p2nd_buffer;
