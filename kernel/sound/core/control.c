...
extern int msm8960_headset_hp_state(void);
extern int msm8960_headset_bu_state(void);
...
static int snd_ctl_hp_state(struct snd_ctl_elem_hp_state __user *_state)
{
	...
	state.hp_state = msm8960_headset_hp_state();
	state.button_state = msm8960_headset_bu_state();
