...
static struct snd_soc_dai_link msm8960_dai_common[] = {
	...
	/* AUX PCM Backend DAI Links */
	{
		...
		.platform_name = "msm-pcm-routing",
#if defined(CONFIG_SH_AUDIO_DRIVER) && defined(CONFIG_SH_AUDIO_DRIVER_PHS) && defined(CONFIG_SND_SOC_YMU828B) /*02-180*/
		.codec_name = "mc_asoc_a.2-003a",
		.codec_dai_name = "mc_asoc-dio0",
#else
		.codec_name = "msm-stub-codec.1",
		.codec_dai_name = "msm-stub-rx",
#endif /*02-180*/
