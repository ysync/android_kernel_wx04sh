...
#if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 202) || CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 203 || CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 204
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-181*/
#ifdef CONFIG_SH_AUDIO_DRIVER_PHS
static const struct snd_kcontrol_new slimbus_0_rx_mixer_controls[] = {
	SOC_SINGLE_EXT("Voice Stub", MSM_BACKEND_DAI_SLIMBUS_0_RX,
	MSM_FRONTEND_DAI_VOICE_STUB, 1, 0, msm_routing_get_voice_stub_mixer,
	msm_routing_put_voice_stub_mixer),
};
#endif /* CONFIG_SH_AUDIO_DRIVER_PHS */
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-181*/
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-181*/
#ifdef CONFIG_SH_AUDIO_DRIVER_PHS
	SND_SOC_DAPM_MIXER("SLIMBUS_0_RX Mixer", SND_SOC_NOPM, 0, 0,
	slimbus_0_rx_mixer_controls, ARRAY_SIZE(slimbus_0_rx_mixer_controls)),
#endif /* CONFIG_SH_AUDIO_DRIVER_PHS */
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-181*/
...
/* SH_AUDIO_DRIVER -> *//*02-210*/
	{"Voice_Tx Mixer", "INTERNAL_FM_TX", "INT_FM_TX"},
/* SH_AUDIO_DRIVER <- *//*02-210*/
...
/* SH_AUDIO_DRIVER <- *//*02-181*/
	...
	{"Voice Stub Tx Mixer", "AUX_PCM_TX_Voice", "AUX_PCM_TX"},
#endif /* CONFIG_SH_AUDIO_DRIVER_PHS */
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-181*/
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*02-181*/
#ifdef CONFIG_SH_AUDIO_DRIVER_PHS
	{"SLIMBUS_0_RX Mixer", "Voice Stub", "VOICE_STUB_DL"},
	{"SLIMBUS_0_RX", NULL, "SLIMBUS_0_RX Mixer"},
#endif /* CONFIG_SH_AUDIO_DRIVER_PHS */
#endif /* CONFIG_SH_AUDIO_DRIVER *//*02-181*/
